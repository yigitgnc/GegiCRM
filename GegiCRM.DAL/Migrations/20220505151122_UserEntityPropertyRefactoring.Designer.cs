...
namespace GegiCRM.DAL.Migrations
{
    ...
    [Migration("20220505151122_UserEntityPropertyRefactoring")]
    partial class UserEntityPropertyRefactoring
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GegiCRM.Entities.Concrete.AuthorizationsRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            ConcurrencyStamp = "6fa58f02-c6a8-489a-89c2-253d058f4208",
                            CreatedDate = new DateTime(2022, 5, 5, 18, 11, 20, 791, DateTimeKind.Local).AddTicks(7062),
                            Description = "Sistem Admini Full Yetki",
                            IsDeleted = false,
                            ModifiedBy = 1,
                            ModifiedDate = new DateTime(2022, 5, 5, 18, 11, 20, 791, DateTimeKind.Local).AddTicks(7073),
                            Name = "SysAdmin",
            ...
            modelBuilder.Entity("GegiCRM.Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AddedBy = 1,
                            ConcurrencyStamp = "fb4b1675-e4fc-4e52-a5d8-2522f1d63e5a",
                            ...
                            ModifiedBy = 1,
                            Name = "Yigit",
                            PasswordHash = "AQAAAAEAACcQAAAAEPgMQ8V9VxywScL39aw8BigxT5j4h3JwisAFmqa1CtXxDDeQM5XCMvtO2XdM1ZFe/w==",
            ...
            modelBuilder.Entity("GegiCRM.Entities.Concrete.UsersAuthorizationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            EndDate = new DateTime(2032, 5, 5, 18, 11, 20, 791, DateTimeKind.Local).AddTicks(7082),
                            IsDeleted = false,
                            StartDate = new DateTime(2022, 5, 5, 18, 11, 20, 791, DateTimeKind.Local).AddTicks(7081)
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("GegiCRM.Entities.Concrete.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
